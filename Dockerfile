...
ENV PINPOINTING_JAR pinpointing-experiments-0.1.1-SNAPSHOT-06258ba-jar-with-dependencies.jar
...
CMD java -cp $PINPOINTING_JAR org.liveontologies.pinpointing.ExperimentServer --ontologies ontologies.tar.gz --results results.tar.gz --plot plot.svg \
